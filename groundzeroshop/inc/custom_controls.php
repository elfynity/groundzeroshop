<?php class Google_Font_Dropdown_Custom_Control extends WP_Customize_Control{
	private $fonts = false;
	...
	public function get_google_fonts(){
		if (get_transient('mytheme_google_font_list')) {
	        ...
	        $googleApi = 'https://www.googleapis.com/webfonts/v1/webfonts?sort=alpha&key=AIzaSyDhXf2iJy46b4o0uvtiEUbSTYqMgHSY6rs';
